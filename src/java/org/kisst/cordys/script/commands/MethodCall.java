...
public class MethodCall {
	...
	public MethodCall(CompilationContext compiler, final int node, String defaultResultVar) {
		...
		logSoapFault=RelayTrace.parseSeverity(compiler.getSmartAttribute(node, "logSoapFault", RelaySettings.logSoapFaults.get(compiler.getProps())));
		...
		if (timeoutString==null)
			timeout=RelaySettings.timeout.get(compiler.getProps());
		else
